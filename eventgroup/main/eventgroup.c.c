...
#define ESP_WIFI_SSID      "wifissid"
#define ESP_WIFI_PASS      "wifipass"
...
void app_main(void)
{
    ...
    //gpio_config(&test_config);    checking whether the ESP32 has effectively entered deep sleep
    ...
    xTaskCreate(&counter_task, "counter_task", 2048, NULL, 4, NULL);
